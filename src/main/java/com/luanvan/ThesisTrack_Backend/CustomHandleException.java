...
public class CustomHandleException {
    ...
    public ResponseEntity<ErrorMessage> handleForeignKeyNotFoundException(ForeignKeyNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorMessage(ex.getMessage()));
    }
    ...
    public ResponseEntity<ErrorMessage> handleFacultyDuplicateException(FacultyDuplicateException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorMessage(ex.getMessage()));
    }
